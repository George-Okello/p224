...
interface SettingsDocumentData {
  ...
  /**
   * Artstation field in *Settings*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.artstation
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  artstation: prismic.LinkField;
...
/**
 * Primary content in *Biogragraphy → Primary*
 */
export interface BiogragraphySliceDefaultPrimary {
  /**
   * Heading field in *Biogragraphy → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: biogragraphy.primary.heading
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  heading: prismic.KeyTextField;

  /**
   * Description field in *Biogragraphy → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: biogragraphy.primary.description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  description: prismic.RichTextField;

  /**
   * Button Text field in *Biogragraphy → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: biogragraphy.primary.button_text
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  button_text: prismic.KeyTextField;

  /**
   * Button Link field in *Biogragraphy → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: biogragraphy.primary.button_link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  button_link: prismic.LinkField;

  /**
   * Avatar field in *Biogragraphy → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: biogragraphy.primary.avatar
   * - **Documentation**: https://prismic.io/docs/field#image
   */
...
/**
 * Default variation for Biogragraphy Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type BiogragraphySliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<BiogragraphySliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *Biogragraphy*
 */
type BiogragraphySliceVariation = BiogragraphySliceDefault;

/**
 * Biogragraphy Shared Slice
 *
 * - **API ID**: `biogragraphy`
 * - **Description**: Biogragraphy
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type BiogragraphySlice = prismic.SharedSlice<
  "biogragraphy",
  BiogragraphySliceVariation
>;
...
export interface CertificationsSliceDefaultPrimary {
  /**
   * Title field in *Certifications → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: certifications.primary.title
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  title: prismic.KeyTextField;
}
...
export interface CertificationsSliceDefaultItem {
  /**
   * Certificate field in *Certifications → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: certifications.items[].certificate
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
export interface ImageBlockSliceDefaultPrimary {
  ...
  /**
   * Captions field in *ImageBlock → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: image_block.primary.captions
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  captions: prismic.KeyTextField;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      BiogragraphySlice,
      BiogragraphySliceDefaultPrimary,
      BiogragraphySliceVariation,
      BiogragraphySliceDefault,
      CertificationsSlice,
